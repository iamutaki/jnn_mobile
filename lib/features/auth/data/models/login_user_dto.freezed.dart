...
mixin _$LoginUserDto {
 ...
 String? get name; String? get username; List<String> get roles;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LoginUserDto&&(identical(other.name, name) || other.name == name)&&(identical(other.username, username) || other.username == username)&&const DeepCollectionEquality().equals(other.roles, roles));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,username,const DeepCollectionEquality().hash(roles));

@override
String toString() {
  return 'LoginUserDto(name: $name, username: $username, roles: $roles)';
}
...
/// Create a copy of LoginUserDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = freezed,Object? username = freezed,Object? roles = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? name,  String? username,  List<String> roles)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LoginUserDto() when $default != null:
return $default(_that.name,_that.username,_that.roles);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? name,  String? username,  List<String> roles)  $default,) {final _that = this;
switch (_that) {
case _LoginUserDto():
return $default(_that.name,_that.username,_that.roles);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? name,  String? username,  List<String> roles)?  $default,) {final _that = this;
switch (_that) {
case _LoginUserDto() when $default != null:
return $default(_that.name,_that.username,_that.roles);case _:
  return null;
...
class _LoginUserDto implements LoginUserDto {
  const _LoginUserDto({this.name, this.username, final  List<String> roles = const <String>[]}): _roles = roles;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LoginUserDto&&(identical(other.name, name) || other.name == name)&&(identical(other.username, username) || other.username == username)&&const DeepCollectionEquality().equals(other._roles, _roles));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,username,const DeepCollectionEquality().hash(_roles));
...
/// Create a copy of LoginUserDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = freezed,Object? username = freezed,Object? roles = null,}) {
