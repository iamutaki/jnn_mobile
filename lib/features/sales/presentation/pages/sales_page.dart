...
import 'voucher_sale_form_page.dart';
import 'voucher_sale_history_page.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: _SummaryCard(
                icon: FLucideIcons.shoppingCart,
...
enum _MenuType {
  sale(
    ...
    description: 'Catat transaksi penjualan voucher reseller',
    color: Color(0xFF0EA573),
  ),
  history(
    icon: FLucideIcons.clock,
    label: 'Riwayat Penjualan',
    description: 'Lihat histori transaksi penjualan voucher',
      ...
      child: InkWell(
        onTap: () {
          final route = switch (type) {
            _MenuType.sale => MaterialPageRoute(
